/*
I create another attribute for my GoalManager that give the avility to the user of level up.
Everytime that _score increment by 100 the user levels up, and Congrats the player for acommplish it
*/
